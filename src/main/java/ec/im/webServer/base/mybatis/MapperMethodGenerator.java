...
import ec.im.webServer.base.rule.RuleMapperMethodGenerator;
...
public class MapperMethodGenerator {
    ...
    public static void process(Writer writer, CommonTable table, String idProertyClassType, HashSet<String> existMethodSet, KeyGenMode keyGenMode) throws IOException {
        ...
        if (!existMethodSet.contains("genericQuery")) {
            writer.write(addGenericQuery());
        }
...
//        }
    ...
    private static String addGenericQuery() {
        StringBuilder sb = new StringBuilder();
        sb.append("<sql id=\"genericQuery\">                                                                                                                   \n");
        sb.append("    <if test=\"criteria.generic != null\">                                                                                                  \n");
        sb.append("        <trim prefix=\" and (\" prefixOverrides=\"\" suffix=\")\">                                                                          \n");
        sb.append("            <foreach collection=\"criteria.generic.genericCriteria\" item=\"criteriachild\" separator=\"or\">                               \n");
        sb.append("                <if test=\"criteriachild.valid\">                                                                                           \n");
        sb.append("                    <trim prefix=\"(\" prefixOverrides=\"and\" suffix=\")\">                                                                \n");
        sb.append("                        <foreach collection=\"criteriachild.criteria\" item=\"criterion\">                                                  \n");
        sb.append("                            <if test=\"criterion.frontBrackets != null and criterion.frontBrackets != ''\" >                                \n");
        sb.append("                                ${criterion.frontBrackets}                                                                                  \n");
        sb.append("                            </if>                                                                                                           \n");
        sb.append("                            <choose>                                                                                                        \n");
        ...
        sb.append("                                    ${criterion.condition} #{criterion.value}                                                               \n");
        sb.append("                                </when>                                                                                                     \n");
        sb.append("                                <when test=\"criterion.betweenValue\">                                                                      \n");
        sb.append("                                    ${criterion.condition} #{criterion.value} and #{criterion.secondValue}                                  \n");
        sb.append("                                </when>                                                                                                     \n");
        ...
        sb.append("                                </when>                                                                                                     \n");
        sb.append("                            </choose>                                                                                                       \n");
        sb.append("                            <if test=\"criterion.postBrackets != null and criterion.postBrackets != ''\" >                                  \n");
        sb.append("                                ${criterion.postBrackets}                                                                                   \n");
        sb.append("                            </if>                                                                                                           \n");
        sb.append("                            <if test=\"criterion.conditionOperation != null and criterion.conditionOperation != ''\" >                      \n");
        sb.append("                                ${criterion.conditionOperation}                                                                             \n");
        sb.append("                            </if>                                                                                                           \n");
        sb.append("                        </foreach>                                                                                                          \n");
        sb.append("                    </trim>                                                                                                                 \n");
        sb.append("                </if>                                                                                                                       \n");
...
//    }
    ...
    private static String getKeyCondition(CommonTableColumn idColumn, String prefix) {
        ...
        return idColumn.getColumn() + " = #{" + addPrefix + idColumn.getProperty() + ",jdbcType=" + idColumn.getJdbcType() + "}";
    }

    private static String getColumns4Update(String table,List<CommonTableColumn> columnList, String dataPrefix, boolean needif) {
        String prefix = "SET";
        String stuffix = ",";
        String dataPrefixAdd = StringUtils.isNotEmpty(dataPrefix) ? (dataPrefix + ".") : "";
        StringBuilder sb = new StringBuilder();
        sb.append("\n   <trim prefix=\"" + prefix + "\"  suffixOverrides=\"" + stuffix + "\" >");
        for (CommonTableColumn column : columnList) {
            if(isNoUpdateColumn(table,column)){
            ...
            if (isDefault(column)) {
                sb.append("\n    <if test=\"" + dataPrefixAdd + column.getProperty() + " != null\" >");
                sb.append("\n   	  " + column.getColumn() + " = #{" + dataPrefixAdd + column.getProperty() + ",jdbcType=" + column.getJdbcType() + "}" + stuffix);
                sb.append("\n    </if>");
            } else {
                if (needif) {
                    sb.append("\n    <if test=\"" + dataPrefixAdd + column.getProperty() + " != null\" >");
    ...
    private static String getConditions4Update(List<CommonTableColumn> columnList, String prefixSQL) {
        String prefix = "";
        String prefixOverrides = "";

        String addPrefix = "condition.";
        ...
        for (CommonTableColumn column : columnList) {
            if("VARCHAR".equals(column.getJdbcType()) ||  "CHAR".equals(column.getJdbcType())  ||"LONGVARCHAR".equals(column.getJdbcType()) )
            {
                sb.append("\n    <if test=\"" + addPrefix + column.getProperty() + " != null and "+ addPrefix + column.getProperty() +"!=''\" >");
            }else {
                sb.append("\n    <if test=\"" + addPrefix + column.getProperty() + " != null\" >");
            }
            sb.append("\n   	  AND " + column.getColumn() + " = #{" + addPrefix + column.getProperty() + ", jdbcType=" + column.getJdbcType() + "}");
            sb.append("\n    </if>");
        }
        /*String str = "generic";
        sb.append("\n    <if test=\"" + str + " != null\">");
        sb.append("\n      <trim prefix=\" and (\" prefixOverrides=\"\" suffix=\")\">");
        sb.append("\n       <foreach collection=\"generic.genericCriteria\" item=\"criteriachild\" separator=\"or\">\n" +
                "           <if test=\"criteriachild.valid\">\n" +
                "          <trim prefix=\"(\" prefixOverrides=\"and\" suffix=\")\">\n" +
                "            <foreach collection=\"criteriachild.criteria\" item=\"criterion\">\n" +
                "               <if test=\"criterion.frontBrackets != null and criterion.frontBrackets != ''\" >\n"+
